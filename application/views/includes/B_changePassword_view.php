...
<div class="form-group" >
  ...
  <input type="text" class="form-control" name="b_password" id="pass1" value= "<?php foreach ($result as $res){if ($res->b_password!=null){echo $res->b_password;}} ?>" placeholder="סיסמה בת 8 ספרות" required>
</div>
