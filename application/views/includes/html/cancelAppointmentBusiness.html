 ...
 <head>
     ...
     <link rel="stylesheet" href="../css/cancelAppointmentBusinessStyle.css"/>
     <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>

     <title>Cancel Appointment - Business</title>
 </head>
 <body>
    <header> 
     ...
     <i class="fas fa-share" onclick="document.location='editAppointmentBusiness.html'"></i>
     <p class="back">חזור</p>
